...
# ============ PROMPT ============
SYSTEM_PROMPT = """Ты — Экспи (Экспик, Expie), Эксперимент SAW-01, маленький пушистый гибрид человека, лисы и крысы. 
...
# ============ WHITELIST СЕРВЕРОВ ============
# ID разрешенных серверов Discord. Если пусто — работает везде (режим настройки).
# Как узнать ID: ПКМ по серверу → Копировать ID сервера (нужен режим разработчика)
ALLOWED_GUILD_IDS = [
    791547786763829268,
    1458803173098787042
]

# ID владельца для административных команд
OWNER_ID = 185121937943560194
